...
static Model fromJson(const json& root) {
    ...
    if (root.contains("env")) {
        ...
        c.defaultKp = e.value("defaultKp", c.defaultKp);
        c.defaultKv = e.value("defaultKv", c.defaultKv);
        c.damping = e.value("damping", c.damping);
        c.skel_file = e.value("skel_file", c.skel_file);
        c.ground_file = e.value("ground_file", c.ground_file);
        c.muscle_file = e.value("muscle_file", c.muscle_file);
        c.bvh_file = e.value("bvh_file", c.bvh_file);
        ...
        c.cyclicbvh = e.value("cyclicbvh", c.cyclicbvh);
        c.residual = e.value("residual", c.residual);
        c.simHz = e.value("simHz", c.simHz);
        c.controlHz = e.value("controlHz", c.controlHz);
        ...
        c.actionScale = e.value("actionScale", c.actionScale);
        c.timeWarping = e.value("timeWarping", c.timeWarping);
        ...
        c.eoeType = e.value("eoeType", c.eoeType);
        c.rewardType = e.value("rewardType", c.rewardType);
